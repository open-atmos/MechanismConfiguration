...
namespace mechanism_configuration
{
  namespace v0
  {
    ...
    struct Reactions
    {
      std::vector<v1::Arrhenius> arrhenius;
      std::vector<v1::Branched> branched;
      std::vector<v1::CondensedPhaseArrhenius> condensed_phase_arrhenius;
      std::vector<v1::CondensedPhasePhotolysis> condensed_phase_photolysis;
      std::vector<v1::Emission> emission;
      std::vector<v1::FirstOrderLoss> first_order_loss;
      std::vector<v1::SimpolPhaseTransfer> simpol_phase_transfer;
      std::vector<v1::AqueousEquilibrium> aqueous_equilibrium;
      std::vector<v1::WetDeposition> wet_deposition;
      std::vector<v1::HenrysLaw> henrys_law;
      std::vector<v1::Photolysis> photolysis;
      std::vector<v1::Surface> surface;
      std::vector<v1::Troe> troe;
      std::vector<v1::Tunneling> tunneling;
    };

    struct MechanismV0 : public Mechanism
    {
